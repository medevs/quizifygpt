...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center">
      ...
      <div className="bg-gray-100 py-8 px-4 mt-8 rounded-lg shadow-lg w-full max-w-md text-gray-900">
        <h2 className="text-2xl font-semibold mb-4 text-center">How It Works</h2>
        <ol className="space-y-6">
          <li className="flex mb-4 animate__animated animate__fadeIn animate__delay-1s">
            <div className="flex-shrink-0 w-12 h-12 bg-blue-500 rounded-full text-white text-2xl font-semibold flex items-center justify-center">
              1
            </div>
            <div className="ml-4">
          ...
          <li className="flex mb-4 animate__animated animate__fadeIn animate__delay-2s">
            <div className="flex-shrink-0 w-12 h-12 bg-green-500 rounded-full text-white text-2xl font-semibold flex items-center justify-center">
              2
            </div>
            <div className="ml-4">
          ...
          <li className="flex mb-4 animate__animated animate__fadeIn animate__delay-3s">
            <div className="flex-shrink-0 w-12 h-12 bg-yellow-500 rounded-full text-white text-2xl font-semibold flex items-center justify-center">
              3
            </div>
            <div className="ml-4">
          ...
          <li className="flex animate__animated animate__fadeIn animate__delay-4s">
            <div className="flex-shrink-0 w-12 h-12 bg-red-500 rounded-full text-white text-2xl font-semibold flex items-center justify-center">
              4
            </div>
            <div className="ml-4">
